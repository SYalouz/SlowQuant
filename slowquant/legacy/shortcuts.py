import slowquant.legacy.hartreefock.HartreeFock as HF
import slowquant.legacy.hartreefock.UHF as UHF
import slowquant.legacy.basissets.BasisSet as BS
import slowquant.legacy.molecularintegrals.runMolecularIntegrals as MI
import slowquant.legacy.integraltransformation.IntegralTransform as IT
import slowquant.legacy.configurationinteraction.CI as CI
import slowquant.legacy.properties as prop
import slowquant.legacy.mollerplesset.MPn as MP
import slowquant.legacy.coupledcluster.PythonCC as CC
import slowquant.legacy.bomd.BOMD as BO
import numpy as np
