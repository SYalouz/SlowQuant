import numpy as np
import SlowQuant_legacy as HFrun
import slowquant.legacy.basissets.BasisSet as BS
import slowquant.legacy.hartreefock.DIIS as DIIS
import slowquant.legacy.hartreefock.runHartreeFock as HF   
from slowquant.legacy.hartreefock.HartreeFock import HartreeFock
import slowquant.legacy.molecularintegrals.runMolecularIntegrals as MI
from slowquant.legacy.molecularintegrals.runMIcython import boysPrun
import slowquant.legacy.mollerplesset.runMPn as MP
import slowquant.legacy.properties.runProperties as prop
import slowquant.legacy.qfit.Qfit as QFIT
import slowquant.legacy.integraltransformation.IntegralTransform as UF
...
def test_HartreeFock1():
    settings = np.genfromtxt('slowquant/legacy/Standardsettings.csv', delimiter = ';', dtype='str')
    results = {}
    set = {}
