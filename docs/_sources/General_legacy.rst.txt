...
Inside the code are four different objects that ties the different modules together. The basisset object "basis", the inputfile object "input", the settingsfile object "settings" and the results object "results".
...
The inputfile object is a numpy array containing the following informations:
